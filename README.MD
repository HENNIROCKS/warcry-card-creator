# Warcry Card Creator 3.0 – Fighters and Abilities
A fork of [@HENNIROCKS's work](https://github.com/HENNIROCKS/warcry-card-creator). [Stevrak] added another smaller card type, some image stuff and hopes to do more.
